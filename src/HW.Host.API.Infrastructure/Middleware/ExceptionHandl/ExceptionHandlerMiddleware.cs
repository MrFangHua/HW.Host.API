...
using HW.Host.API.Infrastructure.BaiduTranslator;
using HW.Host.API.Infrastructure.Log4Net;
...
namespace HW.Host.API.Infrastructure.Middleware.ExceptionHandl
{
    /// <summary>
    /// 全局异常捕获中间件
    /// </summary>
