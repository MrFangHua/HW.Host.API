namespace HW.Host.API.Application.PhoneModelInfo.Dto
{
    ...
    public class PhoneModelInfoDto
    {
        ...
        /// 租凭时间
        /// </summary>
        public string PhoneLeaseTime { get { return phoneLeaseTime; } set { phoneLeaseTime = value == "1-01-1 0:0:0" || value == "1753-01-1 0:0:0" || value == "1900-01-1 0:0:0" ? "" : value; } }
        ...
        /// 归还时间（租赁归还）
        /// </summary>
        public string PhoneReturnTime { get { return phoneReturnTime; } set { phoneReturnTime = value == "1-01-1 0:0:0" || value == "1753-01-1 0:0:0" || value == "1900-01-1 0:0:0" ? "" : value; } }
        ...
        /// 领取时间
        /// </summary>
        public string ReceiveTime { get { return receiveTime; } set { receiveTime = value == "1-01-1 0:0:0" || value == "1753-01-1 0:0:0" || value == "1900-01-1 0:0:0" ? "" : value; } }
