using HW.Host.API.Application.EmailHistory.Dto;
...
namespace HW.Host.API.Application.EmailHistory
{
    /// <summary>
    /// 邮件历史信息服务
    /// </summary>
    ...
    {
        private readonly IOwnerRepository<HW_EmailHistoryInfo> _context;
        private readonly IEmailServices _emailServices;

        public EmailHistoryInfoService(IOwnerRepository<HW_EmailHistoryInfo> context,
